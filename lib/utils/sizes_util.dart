...
class Devices {
  ...
  Devices._({double? width = 1080.0, double? height = 810.0});
  ...
  /// 初始化设计尺寸
  static void init({double? width = 1080.0, double? height = 810.0}) {
    ...
    var mediaQueryData = MediaQueryData.fromWindow(window);
